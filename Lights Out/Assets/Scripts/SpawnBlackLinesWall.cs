...
public class SpawnBlackLinesWall : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Instantiate(dottedLine, new Vector3(transform.position.x, transform.position.y - .49f * i, transform.position.z), transform.rotation);
